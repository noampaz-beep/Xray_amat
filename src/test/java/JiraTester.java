...
import hudson.plugins.jira.JiraSite.XrayJiraRestClientFactory;
...
public class JiraTester {
    public static void main(String[] args) throws Exception {
        ...
        final XrayJiraRestClient xrayJiraRestClient = new XrayJiraRestClientFactory()
            .createWithBasicHttpAuthentication(uri, JiraConfig.getUsername(), JiraConfig.getPassword(), jiraRestClient);

        final JiraRestService restService = new JiraRestService(uri, jiraRestClient, xrayJiraRestClient, JiraConfig.getUsername(), JiraConfig.getPassword(), JiraSite.DEFAULT_TIMEOUT);
