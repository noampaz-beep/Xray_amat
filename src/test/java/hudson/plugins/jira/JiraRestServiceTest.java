...
public class JiraRestServiceTest {
    ...
    private XrayJiraRestClient xrayClient;
    ...
    public void createMocks() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        xrayClient = mock(XrayJiraRestClient.class);
    ...
    public void baseApiPath() {
        JiraRestService service = new JiraRestService(JIRA_URI, client, xrayClient, USERNAME, PASSWORD, JiraSite.DEFAULT_TIMEOUT);
        assertEquals("/" + JiraRestService.BASE_API_PATH, service.getBaseApiPath());

        URI uri = URI.create("https://example.com/path/to/jira");
        service = new JiraRestService(uri, client, xrayClient, USERNAME, PASSWORD, JiraSite.DEFAULT_TIMEOUT);
    ...
    public void getIssuesFromJqlSearchTimeout() throws TimeoutException, InterruptedException, ExecutionException {
        JiraRestService service = spy(new JiraRestService(JIRA_URI, client, xrayClient, USERNAME, PASSWORD, JiraSite.DEFAULT_TIMEOUT));
